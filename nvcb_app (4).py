...
# Column rename map for the raw dataset
RENAME_MAP = {
...
if predict_clicked:
    # Build full feature vector — unspecified features set to 0
    ...
    st.markdown(f"**Probability score:** `{prob:.3f}`  &nbsp;|&nbsp;  **Threshold:** `{threshold:.3f}`")
    st.divider()
